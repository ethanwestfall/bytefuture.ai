...
[models.bytefuture.ai](https://models.bytefuture.ai/signup) で登録する。クレジットカード不要。初回チャージで最大 50 ドルの 100% マッチボーナスも付く。キーをエクスポートし、Cursor の Models 設定に接続し、二つのルートを追加しよう。
