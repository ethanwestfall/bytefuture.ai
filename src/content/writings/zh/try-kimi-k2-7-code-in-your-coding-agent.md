...
<p>昨天 Moonshot AI 在 Hugging Face 上发布了 <a href="https://huggingface.co/moonshotai/Kimi-K2.7-Code">Kimi K2.7 Code</a>：一个 1 万亿参数的混合专家（MoE）编码模型（激活参数 32B），上下文窗口 256K，权重以 Modified MIT 许可证开放。</p>
  ...
  <p>K2.7 Code 已经上线 <a href="https://models.bytefuture.ai">Token Station</a>，模型 ID 为 <code>kimi/kimi-k2.7-code</code>，按 Moonshot 的标价、零加价提供。</p>
  ...
  <p>首次充值最高可获得 50 美元奖励赠金，按 K2.7 Code 的价格，这笔预算能覆盖一次相当完整的评测；换成 Fable 5，同样这笔钱就只够跑几次提示。这个实验的下行风险几乎为零，而且这笔赠金按 K2.7 Code 的价格足够用上好几周。</p>
  ...
  <ul>
    <li>一个 Token Station 账号（<a href="https://models.bytefuture.ai/signup">免费注册</a>；无需信用卡，也不需要 Moonshot 账号）</li>
...
codex --profile deep   # hard problems on Fable 5</code></pre>
  ...
  <p>到 <a href="https://models.bytefuture.ai/signup">models.bytefuture.ai</a> 注册（无需信用卡，首次充值可获 100% 匹配、最高 50 美元奖励），亲自看看一个才发布一天的开放权重模型，能否以十分之一的价格扛起你 agent 一半的工作量。</p>
