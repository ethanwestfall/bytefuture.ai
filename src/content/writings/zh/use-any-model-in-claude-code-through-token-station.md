...
claude -p "Respond with exactly the word: pong"</code></pre>
  ...
  <p>到 <a href="https://models.bytefuture.ai/signup">models.bytefuture.ai</a> 注册（无需信用卡，首次充值可获 100% 匹配、最高 50 美元奖励），把 <a href="https://models.bytefuture.ai">Token Station</a> key 放进 Claude Code，再把 Claude Code 的各个模型档位指向你真正想用的模型。</p>
