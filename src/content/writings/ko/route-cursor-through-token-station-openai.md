...
[models.bytefuture.ai](https://models.bytefuture.ai/signup)에서 가입하자. 카드 불필요, 첫 충전 시 최대 50달러 보너스도 받을 수 있다. 키를 export하고, OpenAI 어댑터를 연결하고, Cursor의 Models 설정에 연결한 다음, 위의 라우트들을 추가하자.
